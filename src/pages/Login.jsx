...
const handleGoogleSignIn = async () => {
    try {
      const result = await signInWithGoogle(); // Wait for the Google sign-in to complete
  
      // Optionally, you can log the result or do something with the user info
      ...
      console.log(error);
      toast.error(error.message.slice(22, -2)); // Display a friendly error message
    }
  };
...
const handleEmailSignIn = async (e) => {
    ...
    try {
      ...
      // Optionally, log the result or user information
      console.log(result?.user?.email);
