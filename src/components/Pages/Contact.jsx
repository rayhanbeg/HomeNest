    ...
    <section className="py-6 dark:text-gray-900 mt-36">
      ...
      <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
        <div className="py-6 md:py-0 md:px-6">
          ...
          <p className="pt-2 pb-4">We’d Love to Hear from You</p>
          <div className="space-y-4">
            ...
            <p className="flex items-center">
              ...
              <span>mdrayhan40301@gmail.com</span>
            </p>
          </div>
        </div>
        <form
        ...
        >
          ...
          <label className="block">
            ...
            <textarea
              rows="3"
              className="block w-full rounded-md focus:ring focus:ring-opacity-75 focus:dark:ring-violet-600 dark:bg-gray-100 p-2"
            ></textarea>
          </label>
          <button
            type="button"
